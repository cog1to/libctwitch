...
/**
 * Performs map operation over the array of pointers by applying getter function
 ...
 *
 * This is a convenience function to recursively deallocate complex and
 * dynamically allocated data structures. For example, for an array of
 * twitch_v5_follow structs, we can use this function to recursively deallocate
 * all the memory allocated for it by invoking something like this:
 *
 * pointer_array_free(
 *   count, (void **)follows, (void(*)(void*))&twitch_v5_follow_free
 * )
 *
