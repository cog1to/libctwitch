...
void *parse_channel(json_value *channel_object) {
	...
	field_spec schema[] = {
		...
		{
			.name = "profile_banner",
			.dest = &channel->profile_banner,
			.parser = &parse_string
		},
		{
			.name = "created_at",
			.dest = &channel->created_at,
			.parser = &parse_string
		},
		{
			.name = "updated_at",
			.dest = &channel->updated_at,
			.parser = &parse_string
		},
		{
			.name = "language",
			.dest = &channel->language,
			.parser = &parse_string
		},
		{
			.name = "broadcaster_language",
			.dest = &channel->broadcaster_language,
			.parser = &parse_string
		},
		{
			.name = "url",
		...
		{
			.name = "video_banner",
			.dest = &channel->video_banner,
			.parser = &parse_string
		},
		{
			.name = "followers",
			.dest = &channel->followers,
			.parser = &parse_int
		},
		{
			.name = "views",
		...
		{
			.name = "partner",
			.dest = &channel->partner,
			.parser = &parse_bool
		},
		{
			.name = "profile_banner_background_color",
			.dest = &channel->profile_banner_background_color,
			.parser = &parse_string
		},
		{
			.name = "private_video",
			.dest = &channel->private_video,
			.parser = &parse_bool
		},
		{
			.name = "privacy_options_enabled",
			.dest = &channel->privacy_options_enabled,
			.parser = &parse_bool
		},
		{
			.name = "broadcaster_type",
			.dest = &channel->broadcaster_type,
			.parser = &parse_string
		},
		{
			.name = "broadcaster_software",
			.dest = &channel->broadcaster_software,
			.parser = &parse_string
		},
	};
...
void _parse_channel_list(void *dest, json_value *value) {
	if (value->type == json_array) {
		...
		twitch_v5_channel **channels = (twitch_v5_channel **)parse_json_array(
			value,
			&size,
			&parse_channel
		);
...
void *parse_follow(json_value *follow_object) {
	...
	field_spec schema[] = {
		{
			.name = "created_at",
			.dest = &follow->created_at,
			.parser = &parse_string
		},
		{
			.name = "notifications",
			.dest = &follow->notifications,
			.parser = &parse_bool
		},
		{
			.name = "channel",
			.dest = &follow->channel,
			.parser = &_parse_channel
		}
	};
	parse_entity(follow_object, sizeof(schema)/sizeof(field_spec), schema);
...
void *parse_stream(json_value *stream_object) {
	...
	field_spec schema[] = {
		...
		{
			.name = "created_at",
			.dest = &stream->created_at,
			.parser = &parse_string
		},
		{
			.name = "average_fps",
			.dest = &stream->average_fps,
			.parser = &parse_double
		},
		{
			.name = "channel",
...
void *parse_follower(json_value *value) {
	...
	field_spec schema[] = {
		{
			.name = "created_at",
			.dest = &follower->created_at,
			.parser = &parse_string
		},
		{
			.name = "notifications",
			.dest = &follower->notifications,
			.parser = &parse_int
		},
		{
			.name = "user",
...
void *parse_community(json_value *value) {
	...
	field_spec schema[] = {
		...
		{
			.name = "owner_id",
			.dest = &community->owner_id,
			.parser = &parse_id
		},
		{
			.name = "avatar_image_url",
			.dest = &community->avatar_image_url,
			.parser = &parse_string
		},
		{
			.name = "cover_image_url",
			.dest = &community->cover_image_url,
			.parser = &parse_string
		},
		{
			.name = "description",
			.dest = &community->description,
			.parser = &parse_string
		},
		{
			.name = "description_html",
			.dest = &community->description_html,
			.parser = &parse_string
		},
		{
			.name = "rules",
			.dest = &community->rules,
			.parser = &parse_string
		},
		{
			.name = "rules_html",
			.dest = &community->rules_html,
			.parser = &parse_string
		},
		{
			.name = "name",
		...
		{
			.name = "display_name",
			.dest = &community->display_name,
			.parser = &parse_string
		},
		{
			.name = "summary",
			.dest = &community->summary,
			.parser = &parse_string
		},
	};
	parse_entity(value, sizeof(schema)/sizeof(field_spec), schema);
...
void *parse_resolutions(json_value *value) {
	...
	field_spec schema[] = {
		{
			.name = "chunked",
			.dest = &resolutions->chunked,
			.parser = &parse_string
		},
		{
			.name = "high",
			.dest = &resolutions->high,
			.parser = &parse_string
		},
		{
			.name = "medium",
			.dest = &resolutions->medium,
			.parser = &parse_string
		},
		{
			.name = "low",
			.dest = &resolutions->low,
			.parser = &parse_string
		},
		{
			.name = "mobile",
			.dest = &resolutions->mobile,
			.parser = &parse_string
		},
	};
	parse_entity(value, sizeof(schema)/sizeof(field_spec), schema);
...
void _parse_thumbnail_list(void *dest, json_value *value) {
	if (value->type == json_array) {
		int size = 0;
		twitch_v5_thumbnail **thumbs =
			(twitch_v5_thumbnail **)parse_json_array(value, &size, &parse_thumbnail);
...
void *parse_video(json_value *value) {
	...
	field_spec schema[] = {
		...
		{
			.name = "broadcast_id",
			.dest = &video->broadcast_id,
			.parser = &parse_id
		},
		{
			.name = "channel",
			.dest = &video->channel,
			.parser = &_parse_channel_ref
		},
		{
			.name = "created_at",
		...
		{
			.name = "thumbnails",
			.dest = &video->thumbnails,
			.parser = &_parse_video_thumbnails
		},
		{
			.name = "title",
			.dest = &video->title,
