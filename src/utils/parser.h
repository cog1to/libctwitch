...
/**
 * Creates a new twitch_v5_user struct and tries to fill it with properties from
 * provided JSON value.
 *
 * @param user_object JSON object holding user data fields.
 *
 * @return Pointer to newly allocated twitch_v5_user struct filled with data
 * from JSON value.
 */
void *parse_user(json_value *user_object);

/**
 * Creates a new twitch_v5_channel struct and tries to fill it with properties
 * from provided JSON value.
 *
 * @param channel_object JSON object holding user data fields.
 *
 * @return Pointer to newly allocated twitch_v5_channel struct filled with data
 * from JSON value.
 */
void *parse_channel(json_value *channel_object);

/**
 * Creates a new twitch_v5_follow struct and tries to fill it with properties
 * from provided JSON value.
 *
 * @param follow_object JSON object holding follow data fields.
 *
 * @return Pointer to newly allocated twitch_v5_follow struct filled with data
 * from JSON value.
 */
void *parse_follow(json_value *follow_object);

/**
 * Creates a new twitch_v5_stream struct and tries to fill it with properties
 * from provided JSON value.
 *
 * @param stream_object JSON object holding user data fields.
 *
 * @return Pointer to newly allocated twitch_v5_stream struct filled with data
 * from JSON value.
 */
void *parse_stream(json_value *stream_object);

/**
 * Creates a new twitch_v5_summary struct and tries to fill it with properties
 * from provided JSON value.
 *
 * @param summary_object JSON object holding stream summary data fields.
 *
 * @return Pointer to newly allocated twitch_v5_summary struct filled with data
 * from JSON value.
 */
void *parse_summary(json_value *summary_object);

/**
 * Creates a new twitch_v5_featured_stream struct and tries to fill it with
 * properties from provided JSON value.
 *
 * @param featured_object JSON object holding featured stream data fields.
 *
 * @return Pointer to newly allocated twitch_v5_featured_stream struct filled
 * with data from JSON value.
 */
void *parse_featured_stream(json_value *featured_object);

/**
 * Creates a new twitch_v5_game struct and tries to fill it with properties from
 * provided JSON value.
 *
 * @param value JSON object holding game data fields.
 *
 * @return Pointer to newly allocated twitch_v5_game struct filled with data
 * from JSON value.
 */
void *parse_game(json_value *value);

/**
 * Creates a new twitch_v5_top_game struct and tries to fill it with properties
 * from provided JSON value.
 *
 * @param value JSON object holding top Game data fields.
 *
 * @return Pointer to newly allocated twitch_v5_top_game struct filled with data
 * from JSON value.
 */
void *parse_top_game(json_value *value);

/**
 * Creates a new twitch_v5_follower struct and fills it with properties from
 * JSON value.
 *
...
/**
 * Creates a new twitch_v5_team struct and fills it with properties from JSON
 * value.
 *
...
/**
 * Creates a new twitch_v5_community struct and fills it with properties from
 * JSON value.
 *
 * @param value JSON value holding data fields.
 *
...
/**
 * Creates a new twitch_v5_resolutions struct and fills it with properties from
 * JSON value.
 *
...
/**
 * Creates a new twitch_v5_fps struct and fills it with properties from JSON
 * value.
 *
 * @param value JSON value to parse.
 *
...
/**
 * Creates a new twitch_v5_channel_ref struct and fills it with properties from
 * JSON value.
 *
 * @param value JSON value to parse.
 *
...
/**
 * Creates a new twitch_v5_thumbnail struct and fills it with properties from
 * JSON value.
 *
 * @param value JSON value to parse.
 *
...
/**
 * Creates a new twitch_v5_thumbnail_list struct and fills it with properties
 * from JSON value.
 *
 * @param value JSON value to parse.
 *
...
/**
 * Creates a new twitch_v5_video_thumbnails struct and fills it with properties
 * from JSON value.
 *
 * @param value JSON value to parse.
 *
...
/**
 * Creates a new twitch_v5_video struct and fills it with properties from JSON
 * value.
 *
 * @param value JSON value to parse.
 *
