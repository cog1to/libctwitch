...
string_t *channel_search_url_builder(void *params, int limit, int offset, const char *cursor) {
...
string_t *stream_search_url_builder(void *params, int limit, int offset, const char *cursor) {
...
string_t *game_search_url_builder(void *params, int limit, int offset, const char *cursor) {
...
twitch_channel **twitch_v5_search_channels(const char *client_id, const char *query, int limit, int offset, int *size, int *total) {
  ...
  twitch_channel **channels = (twitch_channel **)get_page(client_id, &channel_search_url_builder, &params, limit, offset, NULL, "channels", &parse_channel, size, total, NULL);
  return channels;
}
...
twitch_stream **twitch_v5_search_streams(const char *client_id, const char *query, stream_filter filter, int limit, int offset, int *size, int *total) {
  ...
  twitch_stream **streams = (twitch_stream **)get_page(client_id, &stream_search_url_builder, &params, limit, offset, NULL, "streams", &parse_stream, size, total, NULL);
  return streams;
}
...
twitch_game **twitch_v5_search_games(const char *client_id, const char *query, bool live, int *size) {
  ...
  int total = 0;
  twitch_game **games = (twitch_game **)get_page(client_id, &game_search_url_builder, &params, 0, 0, NULL, "games", &parse_game, size, &total, NULL);
  return games;
}
