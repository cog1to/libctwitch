 ...
 *
 * @return Instance of twitch_stream_list struct with streams matching given search string. Don't forget to free the memory with twitch_v5_stream_list_free().
 */
