 ...
 */
twitch_follower **twitch_v5_get_channel_followers(const char *client_id, const char *channel_id, int limit, int offset, const char *cursor, const char *direction, int *size, int *total);
