 ...
 * twitch_follower structs with that data.
 *
 * @param client_id Twitch API client ID.
 * @param channel_id Channel ID.
 * @param limit Page size.
 * @param cursor "Tells the server where to start fetching the next set of
 * results." I am not sure about the purpose of this param when you have
 * "offset".
 ...
 * */
twitch_v5_follower_list *twitch_v5_get_channel_followers(
 ...
 * */
twitch_v5_follower_list *twitch_v5_get_all_channel_followers(
	const char *client_id,
	const char *channel_id,
	const char *direction
);
 ...
 * */
twitch_v5_team_list *twitch_v5_get_channel_teams(
	const char *client_id,
	const char *channel_id
);
 ...
 * @param channel_id Channel ID.
 *
 * @return List of communities in a twitch_community_list struct. You will have
 * to manually free the memory and the array itself.
 */
twitch_v5_community_list *twitch_v5_get_channel_communities(
	const char *client_id,
	const char *channel_id
);
 ...
 * @param broadcast_type Comma-separated list of broadcast types. Possible
 * values: 'archive', 'highlight', 'upload'. Default: all of them.
 * @param language Comma-separated list of language/locale abbreviations, e.g.
 ...
 * */
twitch_v5_video_list *twitch_v5_get_channel_videos(
	const char *client_id,
	const char *channel_id,
	int limit,
	int offset,
 ...
 *
 * @return List of all videos on a given channel inside twitch_video_list
 * struct.
 */
twitch_v5_video_list *twitch_v5_get_all_channel_videos(
	const char *client_id,
	const char *channel_id,
	const char *broadcast_type,
	const char *language,
