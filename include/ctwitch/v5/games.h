 ...
 *
 * @return An array of pointers to dynamically allocated twitch_top_game
 * structs. You will have to deallocate it, either manually or using
 * twitch_v5_top_game_list_free() function.
 */
twitch_v5_top_game_list *twitch_v5_get_top_games(
...
/**
 * Returns the full list of games on Twitch, sorted by number of current
 * viewers, most popular first.
 *
 * @param client_id Twitch API client ID.
 *
 * @return An array of pointers to dynamically allocated twitch_top_game
